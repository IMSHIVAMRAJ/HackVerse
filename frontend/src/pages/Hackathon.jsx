    ...
    <div className="font-sans">
      <div className="text-center bg-gradient-to-r from-indigo-500 to-purple-500 text-white py-16">
        ...
        <div className="space-x-4">
          <button className="bg-white text-indigo-600 px-6 py-2 rounded-full font-semibold">Get Started</button>
          <button className="bg-indigo-700 px-6 py-2 rounded-full font-semibold">Browse Hackathons</button>
        </div>
      </div>
          ...
          {hackathons.ongoing.map((hack, index) => (
            <div key={index} className="bg-white shadow rounded-lg overflow-hidden">
              ...
              <div className="p-4">
                ...
                <span className="mt-2 inline-block bg-green-100 text-green-700 text-xs px-2 py-1 rounded-full">{hack.tag}</span>
              </div>
            </div>
          ))}
        </div>
          ...
          {hackathons.upcoming.map((hack, index) => (
            <div key={index} className="bg-white shadow rounded-lg overflow-hidden">
              ...
              <div className="p-4">
                ...
                <span className="mt-2 inline-block bg-blue-100 text-blue-700 text-xs px-2 py-1 rounded-full">{hack.tag}</span>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-sm text-gray-600 mt-2">Win exciting prizes and get recognized for your creativity and innovation.</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 mt-2">Gain visibility for top tech companies and startups worldwide.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <div className="text-center bg-gradient-to-r from-indigo-500 to-purple-500 text-white py-12">
        ...
        <button className="bg-white text-purple-700 px-6 py-2 rounded-full font-semibold">Join HackVerse Today</button>
      </div>
    </div>
  );
}
